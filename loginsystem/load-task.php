...
$sql = "SELECT user_task.task_id, user_task.user_task_a FROM user_task, users WHERE user_task.user_id = $user_id_task AND users.user_id = $user_id_task LIMIT $taskNewCount";
